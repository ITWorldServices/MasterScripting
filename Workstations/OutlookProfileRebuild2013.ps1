...
New-Item -Path C:\Temp\MailProfileBackup -ItemType Directory

#Backup registry for all existing mail profiles to backup directory
reg export HKCU\SOFTWARE\Microsoft\Office\15.0\Outlook\Profiles c:\Temp\MailProfileBackup\allprofiles.reg
