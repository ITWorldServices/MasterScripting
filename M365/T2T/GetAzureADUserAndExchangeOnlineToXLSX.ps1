...
# Export to Excel
$excelPath = "C:\temp\UserExport.xlsx"
$userData | Export-Excel -Path $excelPath -AutoSize -TableName "UserData" -WorksheetName "User Information" -TableStyle Medium1 -FreezeTopRow -BoldTopRow

Write-Host "Data exported to $excelPath" -ForegroundColor Green
