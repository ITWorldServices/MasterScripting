...
$i = 0
#Iterate teams one bye one and get channels 
...
#Iterate users one bye one and add to result array
ForEach ($TeamUser in $TeamUsers)
{
#Add user info to result array
...
$Result | Export-CSV "C:\temp\AllTeamMembers.CSV" -NoTypeInformation -Encoding UTF8