function Get-bdcMicrosoftTeamsReporting
{
   <#
         ...
         .REQUIREMENT
		 Must have MicrosoftTeams Module installed
		 Check if it's installed with "Get-Module -ListAvailable -Name MicrosoftTeams"
		 If you get no results, install the module with "Install-Module MicrosoftTeams"
